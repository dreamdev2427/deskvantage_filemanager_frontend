...
const FMTreeView = (props) => {
          ...
          ? treedata.children.map((node) => (
              ...
              >
                <div className="flex">
                  ...
                  <div
                    className={`ml-1 text-[14px] font-medium text-custom-black `}
                  >
  ...
  const dropObj = (event: Event) => {
    ...
    treeA.current!.addTo(
      `<div class="flex"><svg class="MuiSvgIcon-root MuiSvgIcon-fontSizeMedium css-1fjwcaq-MuiSvgIcon-root" focusable="false" aria-hidden="true" viewBox="0 0 24 24" data-testid="FilePresentIcon"><path d="M15 2H6c-1.1 0-2 .9-2 2v16c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V7l-5-5zM6 20V4h8v4h4v12H6zm10-10v5c0 2.21-1.79 4-4 4s-4-1.79-4-4V8.5c0-1.47 1.26-2.64 2.76-2.49 1.3.13 2.24 1.32 2.24 2.63V15h-2V8.5c0-.28-.22-.5-.5-.5s-.5.22-.5.5V15c0 1.1.9 2 2 2s2-.9 2-2v-5h2z"></path></svg><div class="ml-1 text-[14px] font-medium text-custom-black "}><div class="relative group">` +
