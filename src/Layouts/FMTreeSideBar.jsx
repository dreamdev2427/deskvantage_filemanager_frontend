...
const FMTreeSideBar = () => {
  ...
  return (
    <div className="flex w-full flex-col pl-4 relative h-full">
      <div className="absolute -top-[23px] right-[46px] group">
        <button
      ...
      "
        ...
        <div
          className="hidden group-hover:flex w-[240px] absolute z-10 left-[24px] top-[24px]  flex-col gap-3 bg-white shadow-md
